            ...
            <ul class="nav pull-right">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="#"><i class="icon-comment"></i>Successful attack<span class="time">24 secs ago</span></a></li>
                  <li><a href="#"><i class="icon-lock"></i>Failed attack<span class="time">30 mins ago</span></a></li>
